...
CREATE TABLE Reservation (reservationId int(10) NOT NULL AUTO_INCREMENT, customerId int(10) NOT NULL, reservationTime time NOT NULL, reservationStatus int(1) NOT NULL, staffId int(10) NOT NULL, deskId int(10) NOT NULL, numberOfTickets int(2) NOT NULL, discountId int(10) NOT NULL, reservationAmount double NOT NULL, PRIMARY KEY (reservationId));
...
CREATE TABLE Food (foodId int(10) NOT NULL AUTO_INCREMENT, foodName varchar(100) NOT NULL, foodImage varchar(255) NOT NULL, foodDescription varchar(255) NOT NULL, PRIMARY KEY (foodId));
